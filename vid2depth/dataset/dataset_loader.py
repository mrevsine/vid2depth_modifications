...
class Custom(object):
  ...
  """Load intrinsics."""
    ...
    # # GoPro: These numbers are for images with resolution 2250 x 3000.
    # Assuming FOVx = 94.4 => fx = (3000 // 2) / math.tan(FOVx / 2) = 1389.0
    intrinsics = np.array([[1389.0, 0, 1280 // 2],
                           [0, 1542.8, 2250 // 2],
                           [0, 0, 1.0]])
    return intrinsics
...
class KittiRaw(object):
  ...
  def __init__(self,
    ...
    self.cam_ids = ['00']
    self.date_list = ['100GOPRO', '101GOPRO', 
                      '102GOPRO', '103GOPRO', 
                      '104GOPRO', '105GOPRO']
